...
internal sealed partial class Model
{
    ...
    internal struct PpmContext
    {
        ...
        /// </summary>
        public readonly PpmState Statistics
        {
            get =>
                new PpmState(
                    _memory[_address + 4]
        ...
        /// </summary>
        public readonly byte FirstStateFrequency
        {
    ...
    private void Rescale(PpmContext context)
    {
        ...
        if (state.Frequency == 0)
        {
            ...
            if (context.NumberStatistics == 0)
            {
                ...
                localFrequency = (byte)(
                    ((2 * localFrequency) + escapeFrequency - 1) / escapeFrequency
                );
                ...
                context.Flags = (byte)(
                    (context.Flags & 0x10) + ((localSymbol >= 0x40) ? 0x08 : 0x00)
                );
