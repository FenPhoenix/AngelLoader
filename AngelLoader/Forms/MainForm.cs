    ...
    IMessageFilter
{
    ...
    */
    ...
    {
        if (sender is not DarkLabel label) return;
    ...
    */
    ...
    private void FMTabsMenuButton_Paint(object? sender, PaintEventArgs e) => Images.PaintHamburgerMenuButton_FMTabs((Button)sender!, e);
