...
namespace AngelLoader.Forms.CustomControls.SettingsPages
{
    public sealed partial class FMDisplayPage
    {
        private void InitComponentManual()
        {
            ...
            RatingUseStarsCheckBox = new CheckBox();
            ...
            DateSeparator3TextBox = new TextBox();
            DateSeparator2TextBox = new TextBox();
            Date1ComboBox = new ComboBox();
            DateSeparator1TextBox = new TextBox();
            Date4ComboBox = new ComboBox();
            Date2ComboBox = new ComboBox();
            Date3ComboBox = new ComboBox();
            ...
            MoveArticlesToEndCheckBox = new CheckBox();
            EnableIgnoreArticlesCheckBox = new CheckBox();
            ArticlesTextBox = new TextBox();
            GameOrganizationGroupBox = new GroupBox();
            UseShortGameTabNamesCheckBox = new CheckBox();
