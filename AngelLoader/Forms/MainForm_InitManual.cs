    ...
    public sealed partial class MainForm
    {
        ...
        */
        ...
        private void InitComponentManual()
        {
            ...
            FilterTitleLabel = new LabelCustom();
            FilterTitleTextBox = new TextBoxCustom();
            FilterAuthorLabel = new LabelCustom();
            ...
            CR_MoviesCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_MotionsCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_SoundsCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_CreaturesCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_TexturesCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_AutomapCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_ScriptsCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_SubtitlesCheckBox = new DarkUI.Controls.DarkCheckBox();
            CR_ObjectsCheckBox = new DarkUI.Controls.DarkCheckBox();
            CustomResourcesLabel = new LabelCustom();
            EditFMTabPage = new TabPageCustom();
            EditFMScanLanguagesButton = new DarkUI.Controls.DarkButton();
            EditFMLanguageLabel = new LabelCustom();
            ...
            EditFMRatingLabel = new LabelCustom();
            EditFMLastPlayedDateTimePicker = new DateTimePicker();
            EditFMReleaseDateDateTimePicker = new DateTimePicker();
            EditFMLastPlayedCheckBox = new DarkUI.Controls.DarkCheckBox();
            EditFMReleaseDateCheckBox = new DarkUI.Controls.DarkCheckBox();
            EditFMDisableAllModsCheckBox = new DarkUI.Controls.DarkCheckBox();
            EditFMDisabledModsTextBox = new DarkUI.Controls.DarkTextBox();
            EditFMDisabledModsLabel = new LabelCustom();
            EditFMAuthorTextBox = new DarkUI.Controls.DarkTextBox();
            EditFMAuthorLabel = new LabelCustom();
            EditFMTitleLabel = new LabelCustom();
            ...
            PatchDMLPatchesLabel = new LabelCustom();
            ...
            PatchFMNotInstalledLabel = new LabelCustom();
