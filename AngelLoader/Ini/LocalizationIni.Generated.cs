...
namespace AngelLoader
{
    ...
    {
        #region Autogenerated per-game string getters

        internal static string GetGameTitle(GameSupport.GameIndex gameIndex)
        {
            return
                gameIndex == GameSupport.GameIndex.Thief1 ? Misc.LText.Global.Thief1:
                gameIndex == GameSupport.GameIndex.Thief2 ? Misc.LText.Global.Thief2:
                gameIndex == GameSupport.GameIndex.Thief3 ? Misc.LText.Global.Thief3:
                Misc.LText.Global.SystemShock2;
        }

        internal static string GetGameTitleShort(GameSupport.GameIndex gameIndex)
        {
            return
                gameIndex == GameSupport.GameIndex.Thief1 ? Misc.LText.Global.Thief1_Short:
                gameIndex == GameSupport.GameIndex.Thief2 ? Misc.LText.Global.Thief2_Short:
                gameIndex == GameSupport.GameIndex.Thief3 ? Misc.LText.Global.Thief3_Short:
                Misc.LText.Global.SystemShock2_Short;
        }

        internal static string GetGameTitleColon(GameSupport.GameIndex gameIndex)
        {
            return
                gameIndex == GameSupport.GameIndex.Thief1 ? Misc.LText.Global.Thief1_Colon:
                gameIndex == GameSupport.GameIndex.Thief2 ? Misc.LText.Global.Thief2_Colon:
                gameIndex == GameSupport.GameIndex.Thief3 ? Misc.LText.Global.Thief3_Colon:
                Misc.LText.Global.SystemShock2_Colon;
        }

        internal static string GetGamePlayOriginalText(GameSupport.GameIndex gameIndex)
        {
            return
                gameIndex == GameSupport.GameIndex.Thief1 ? Misc.LText.PlayOriginalGameMenu.Thief1_PlayOriginal:
                gameIndex == GameSupport.GameIndex.Thief2 ? Misc.LText.PlayOriginalGameMenu.Thief2_PlayOriginal:
                gameIndex == GameSupport.GameIndex.Thief3 ? Misc.LText.PlayOriginalGameMenu.Thief3_PlayOriginal:
