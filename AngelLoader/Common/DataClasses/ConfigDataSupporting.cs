...
public sealed class ScreenshotWatcher
{
    ...
    private readonly GameIndex _gameIndex;

    private static readonly ScreenshotWatcherTimer _timer = new(1000) { Enabled = false, AutoReset = false };
    ...
    public ScreenshotWatcher(GameIndex gameIndex)
    {
