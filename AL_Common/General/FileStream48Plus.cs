...
/*
 * FileStream48Plus supports different modes of accessing the disk - async mode
 ...
 *
 * Also buffering is added into FileStream48Plus as well. Folded in the
 * code from BufferedStream, so all the comments about it being mostly
 * aggressive (and the possible perf improvement) apply to FileStream48Plus as 
...
namespace AL_Common
{
    ...
    // We should probably make this a nested type of FileStream48Plus. But 
    ...
    unsafe internal sealed class FileStreamAsyncResult : IAsyncResult
    {
        ...
        unsafe private static void AsyncFSCallback(uint errorCode, uint numBytes, NativeOverlapped* pOverlapped)
        {
            ...
            if (errorCode == FileStream48Plus.ERROR_BROKEN_PIPE || errorCode == FileStream48Plus.ERROR_NO_DATA)
                errorCode = 0;
    ...
    [ComVisible(true)]
    public class FileStream48Plus : Stream
    {
        ...
        //Any changes to FileStream48Plus must include the corresponding changes in IsolatedStorage.
        internal FileStream48Plus()
        {
        }
#if FEATURE_CORECLR
        ...
        public FileStream48Plus(String path, FileMode mode) 
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileAccess access) 
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share) 
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize) 
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize, FileOptions options)
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize, bool useAsync)
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileSystemRights rights, FileShare share, int bufferSize, FileOptions options, FileSecurity fileSecurity)
        {
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(String path, FileMode mode, FileSystemRights rights, FileShare share, int bufferSize, FileOptions options)
        {
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize, FileOptions options, String msgPath, bool bFromProxy)
        {
            Win32Native.SECURITY_ATTRIBUTES secAttrs = GetSecAttrs(share);
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize, FileOptions options, String msgPath, bool bFromProxy, bool useLongPath)
        {
            Win32Native.SECURITY_ATTRIBUTES secAttrs = GetSecAttrs(share);
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal FileStream48Plus(String path, FileMode mode, FileAccess access, FileShare share, int bufferSize, FileOptions options, String msgPath, bool bFromProxy, bool useLongPath, bool checkHost)
        {
            Win32Native.SECURITY_ATTRIBUTES secAttrs = GetSecAttrs(share);
        ...
        private void Init(String path, FileMode mode, FileAccess access, int rights, bool useRights, FileShare share, int bufferSize, FileOptions options, Win32Native.SECURITY_ATTRIBUTES secAttrs, String msgPath, bool bFromProxy, bool useLongPath, bool checkHost)
        {
            ...
            try
            {
                ...
                if (_handle.IsInvalid)
                {
                    ...
                    // NT5 oddity - when trying to open "C:\" as a FileStream48Plus,
            ...
            // Disallow access to all non-file devices from the FileStream48Plus
            ...
            if (seekToEnd)
            {
                _appendStart = Seek_WindowsStrategy(0, SeekOrigin.End);
            }
            else
            {
                _appendStart = -1;
        ...
        [Obsolete("This constructor has been deprecated.  Please use new FileStream48Plus(SafeFileHandle handle, FileAccess access) instead.  http://go.microsoft.com/fwlink/?linkid=14202")]
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(IntPtr handle, FileAccess access)
            : this(handle, access, true, DefaultBufferSize, false)
        {
        }

        [Obsolete("This constructor has been deprecated.  Please use new FileStream48Plus(SafeFileHandle handle, FileAccess access) instead, and optionally make a new SafeFileHandle with ownsHandle=false if needed.  http://go.microsoft.com/fwlink/?linkid=14202")]
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(IntPtr handle, FileAccess access, bool ownsHandle)
            : this(handle, access, ownsHandle, DefaultBufferSize, false)
        {
        }

        [Obsolete("This constructor has been deprecated.  Please use new FileStream48Plus(SafeFileHandle handle, FileAccess access, int bufferSize) instead, and optionally make a new SafeFileHandle with ownsHandle=false if needed.  http://go.microsoft.com/fwlink/?linkid=14202")]
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(IntPtr handle, FileAccess access, bool ownsHandle, int bufferSize)
        ...
        [System.Security.SecuritySafeCritical]  // auto-generated
        [Obsolete("This constructor has been deprecated.  Please use new FileStream48Plus(SafeFileHandle handle, FileAccess access, int bufferSize, bool isAsync) instead, and optionally make a new SafeFileHandle with ownsHandle=false if needed.  http://go.microsoft.com/fwlink/?linkid=14202")]
#pragma warning disable 618
        [SecurityPermissionAttribute(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
#pragma warning restore 618
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(IntPtr handle, FileAccess access, bool ownsHandle, int bufferSize, bool isAsync)
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(SafeFileHandle handle, FileAccess access)
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        public FileStream48Plus(SafeFileHandle handle, FileAccess access, int bufferSize)
...
#pragma warning disable 618
        [SecurityPermissionAttribute(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
#pragma warning restore 618
        public FileStream48Plus(SafeFileHandle handle, FileAccess access, int bufferSize, bool isAsync)
        {
            ...
            Contract.Assert(handleType == Win32Native.FILE_TYPE_DISK || handleType == Win32Native.FILE_TYPE_PIPE || handleType == Win32Native.FILE_TYPE_CHAR, "FileStream48Plus was passed an unknown file type!");
...
#endif //!FEATURE_PAL
            if (_canSeek)
                Seek_WindowsStrategy(0, SeekOrigin.Current);
            else
                _pos = 0;
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            // design for FileStream48Plus, which would often "just work" when 
            // finalized.
            try
            {
        ...
        ~FileStream48Plus()
        {
            if (_handle != null)
            {
                BCLDebug.Correctness(_handle.IsClosed, "You didn't close a FileStream48Plus & it got finalized.  Name: \"" + _fileName + "\"");
                Dispose(false);
            }
        }
        ...
        {
            Contract.Assert(_writePos == 0, "FileStream48Plus: Write buffer must be empty in FlushRead!");
            if (_readPos - _readLen != 0)
            {
                Contract.Assert(CanSeek, "FileStream48Plus will lose buffered read data now.");
                Seek_WindowsStrategy(_readPos - _readLen, SeekOrigin.Current);
            }
            _readPos = 0;
            _readLen = 0;
        }
        ...
        {
            Contract.Assert(_readPos == 0 && _readLen == 0, "FileStream48Plus: Read buffer must be empty in FlushWrite!");
        ...
        [Obsolete("This property has been deprecated.  Please use FileStream48Plus's SafeFileHandle property instead.  http://go.microsoft.com/fwlink/?linkid=14202")]
        ...
        // @FileStreamNET: Not yet converted to cached length
        [System.Security.SecuritySafeCritical]  // auto-generated
        ...
        private void SetLengthCore(long value)
        {
            ...
            if (_exposedHandle)
                VerifyOSHandlePosition();
            if (_pos != value)
                Seek_WindowsStrategy(value, SeekOrigin.Begin);
            ...
            {
                if (origPos < value)
                    Seek_WindowsStrategy(origPos, SeekOrigin.Begin);
                else
                    Seek_WindowsStrategy(0, SeekOrigin.End);
            }
        }
        ...
        private unsafe int ReadCore(byte[] buffer, int offset, int count)
        {
            ...
            NativeOverlapped overlapped = GetNativeOverlappedForSyncHandle(_handle, _filePosition);
            //fixed (byte* pinned = &MemoryMarshal.GetReference(buffer.AsSpan()))
            ...
            int hr = 0;
            int r = ReadFileNative(_handle, buffer!, offset, count, &overlapped, out hr);
            if (r == -1)
            {
            ...
            Contract.Assert(r >= 0, "FileStream48Plus's ReadCore is likely broken.");
            _pos += r;
        ...
        private long SeekCore(long offset, SeekOrigin origin)
        {
            ...
            if (ret == -1)
            {
                ...
                // values (due to invalid but unclosed handle) in SQL FileStream48Plus 
                // scenarios.
                // 
        ...
        // This will fail if someone else moved the FileStream48Plus's handle or if
        // we've hit a bug in FileStream48Plus's position updating code.
        private void VerifyOSHandlePosition()
        {
            ...
            long oldPos = _pos;
            long curPos = Seek_WindowsStrategy(0, SeekOrigin.Current);
        ...
        public override void Write(byte[] array, int offset, int count)
        {
            ...
            {
                Contract.Assert(_writePos == 0, "FileStream48Plus cannot have buffered data to write here!  Your stream will be corrupted.");
        ...
        private unsafe void WriteCore(byte[] buffer, int offset, int count)
        {
            ...
            Contract.Assert(r >= 0, "FileStream48Plus's WriteCore is likely broken.");
            _pos += r;
            return;
        }
        ...
        private FileStreamAsyncResult BeginReadAsync(byte[] array, int offset, int numBytes, AsyncCallback userCallback, Object stateObject)
        {
            ...
            if (_isPipe)
            {
                ...
                // FileStream48Plus's BeginRead blocks waiting for data to fill it's 
                ...
                {
                    Contract.Assert(_writePos == 0, "FileStream48Plus must not have buffered write data here!  Pipes should be unidirectional.");
        ...
        private FileStreamAsyncResult BeginWriteAsync(byte[] array, int offset, int numBytes, AsyncCallback userCallback, Object stateObject)
        {
            ...
            if (_isPipe)
            {
                ...
                // To avoid this deadlock, don't buffer when doing async IO on
                // pipes.   
                Contract.Assert(_readPos == 0 && _readLen == 0, "FileStream48Plus must not have buffered data here!  Pipes should be unidirectional.");
        ...
        public override Task<int> ReadAsync(Byte[] buffer, int offset, int count, CancellationToken cancellationToken)
        {
            ...
            if (this.GetType() != typeof(FileStream48Plus))
            ...
            // if this FileStream48Plus was not opened with FileOptions.Asynchronous.
            if (!_isAsync)
                return base.ReadAsync(buffer, offset, count, cancellationToken);
        ...
        public override Task FlushAsync(CancellationToken cancellationToken)
        {
            ...
            if (CanWrite)
                return Task.Factory.StartNew(
                    state => ((FileStream48Plus)state).FlushOSBuffer(),
                    this,
                    cancellationToken,
        ...
        public override long Position
        {
            get
            {
                ...
                return Position_BufferedStrategy;
            }
            set
            {
                if (value < 0)
                ...
                Position_BufferedStrategy = value;
            }
        }

        public long Position_BufferedStrategy
        {
            get
            {
                Debug.Assert(!(_writePos > 0 && _readPos != _readLen), "Read and Write buffers cannot both have data in them at the same time.");

                return Position_WindowsStrategy + _readPos - _readLen + _writePos;
            }
            set
            {
                Seek_BufferedStrategy(value, SeekOrigin.Begin);
            }
        }

        /// <summary>Gets or sets the position within the current stream</summary>
        public long Position_WindowsStrategy
        {
            get => _filePosition;
            set => Seek_WindowsStrategy(value, SeekOrigin.Begin);
        }
        ...
        public override long Seek(long offset, SeekOrigin origin)
        {
            ...
            return Seek_BufferedStrategy(offset, origin);
        }

        public long Seek_BufferedStrategy(long offset, SeekOrigin origin)
        {
            // If we have bytes in the write buffer, flush them out, seek and be done.
            if (_writePos > 0)
            {
                FlushWrite(false);
                return Seek_WindowsStrategy(offset, origin);
            }
            ...
            Debug.Assert(oldPos == Position_WindowsStrategy + (_readPos - _readLen));

            long newPos = Seek_WindowsStrategy(offset, origin);
            ...
            if (0 <= readPos && readPos < _readLen)
            {
                ...
                Seek_WindowsStrategy(_readLen - _readPos, SeekOrigin.Current);
            }
            else
        ...
        public long Seek_WindowsStrategy(long offset, SeekOrigin origin)
        {
            ...
            else
            {
                ...
                FileStreamHelpers.ThrowInvalidArgument(_handle);
            }
        ...
        private NativeOverlapped GetNativeOverlappedForSyncHandle(SafeFileHandle handle, long fileOffset)
        {
