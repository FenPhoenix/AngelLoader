...
internal static class SR
{
    ...
    internal static readonly string ArgumentOutOfRange_BinaryReaderFillBuffer = "The number of bytes requested does not fit into BinaryReader's public buffer.";
}
