...
{
    internal FileStream ArchiveStream = null!;
    ...
    public ZipContext_Threaded(FileStream archiveStream, long archiveStreamLength)
    {
        ArchiveSubReadStream = new SubReadStream();
        Set(archiveStream, archiveStreamLength);
    }

    public void Set(FileStream archiveStream, long archiveStreamLength)
    {
...
public sealed class ZipContext_Threaded_Pool
{
    ...
    public ZipContext_Threaded Rent(FileStream archiveStream, long archiveStreamLength)
    {
...
public readonly ref struct ZipContextThreadedRentScope
{
    ...
    public ZipContextThreadedRentScope(ZipContext_Threaded_Pool pool, FileStream fs, long fsLength)
    {
        _pool = pool;
