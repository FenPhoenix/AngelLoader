...
public static partial class RTFParserCommon
{
    ...
    public sealed class SymbolDict
    {
        ...
        private readonly byte[] asso_values =
        {
            ...
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 20,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 0, 50, 5,
            15, 5, 10, 80, 35, 15, 5, 5, 55, 95,
            0, 5, 30, 15, 5, 45, 0, 60, 0, 0,
            5, 0, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
            242, 242, 242, 242, 242, 242, 242, 242, 242, 242,
    ...
    public sealed class FontDictionary
    {
        ...
        */
        ...
        public void Clear()
        {
            ...
            _dict?.Clear();
            /*
            An Array.Clear() takes ~177ms of ~184ms taken by the parser Reset() function over 20 runs of the
            standard convert-only full-set test.
            
            An AsSpan().Clear() takes only ~66ms (of Reset() ~72).

            An AsSpan(0, _highestKey).Clear() is ~24ms.
            ...
            */
            ...
            {
                _array.AsSpan(0, _highestKey + 1).Clear();
            }
            else
            {
                _array.AsSpan().Clear();
