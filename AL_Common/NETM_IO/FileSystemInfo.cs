...
namespace AL_Common.NETM_IO
{
    public abstract partial class FileSystemInfo : MarshalByRefObject, ISerializable
    {
        ...
        /// <value><see cref="T:AL_Common.NETM_IO.UnixFileMode" /> of the current <see cref="T:AL_Common.NETM_IO.FileSystemInfo" />.</value>
        ...
        /// <exception cref="T:AL_Common.NETM_IO.DirectoryNotFoundException">The specified path is invalid. Only thrown when setting the property value.</exception>
        /// <exception cref="T:AL_Common.NETM_IO.FileNotFoundException">The specified file doesn't exist. Only thrown when setting the property value.</exception>
        /// <exception cref="T:AL_Common.NETM_IO.IOException"><see cref="M:AL_Common.NETM_IO.FileSystemInfo.Refresh" /> cannot initialize the data.</exception>
        ///
        /// <remarks>
        /// The value may be cached when either the value itself or other <see cref="T:AL_Common.NETM_IO.FileSystemInfo" /> properties are accessed. To get the latest value, call the <see cref="M:AL_Common.NETM_IO.FileSystemInfo.Refresh" /> method.
        ///
