...
namespace AL_Common.NETM_IO
{
    ...
    public enum MatchType
    {
        ...
        /// <c>*</c> matches from zero to any amount of characters. <c>?</c> matches exactly one character. <c>*.*</c> matches any name with a period in it (with <see cref="Win32" />, this would match all items).</para></summary>
        Simple,
