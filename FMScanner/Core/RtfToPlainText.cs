...
namespace FMScanner
{
    internal sealed class RtfToTextConverter
    {
        ...
        private readonly Dictionary<int, int>
        _symbolFontToUnicode = new Dictionary<int, int>
        {
            { 0x21, 0x0021 },
            { 0x22, 0x2200 },
            { 0x23, 0x0023 },
        ...
        private readonly Dictionary<int, int>
        _webdingsFontToUnicode = new Dictionary<int, int>
        {
            { 0x21, 0x1F577 },
            { 0x22, 0x1F578 },
            { 0x23, 0x1F572 },
        ...
        private bool GetCharFromConversionList(int codePoint, Dictionary<int, int> _fontDict, out string _finalChar)
        {
