...
internal static class ZipHelpers
{
    ...
    internal static bool SeekBackwardsToSignature(Stream stream, uint signatureToFind, ZipReusableBundleS bundle)
    {
        int bufferPointer = 0;
    ...
    internal static void AdvanceToPosition(this Stream stream, long position, ZipReusableBundleS bundle)
    {
        ...
        while (numBytesLeft != 0)
        {
            ...
            int numBytesToSkip = numBytesLeft > ZipReusableBundleS.ThrowAwayBufferSize ? ZipReusableBundleS.ThrowAwayBufferSize : (int)numBytesLeft;
